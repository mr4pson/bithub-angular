...
export class CAppComponent {
	...
	get popupSubscriptionActive(): boolean {return this.appService.popupSubscriptionActive;}
    set popupSubscriptionActive(v: boolean) {this.appService.popupSubscriptionActive = v;}
	get popupLimitActive(): boolean {return this.appService.popupLimitActive;}
    set popupLimitActive(v: boolean) {this.appService.popupLimitActive = v;}
	...
	private initLang(slug: string): void {
		...
		if (!lang) {
			this.appService.setLang(this.appService.langs[0]);
			this.router.navigateByUrl(`/${this.appService.lang.value.slug}/errors/404`);
			return;
		}
