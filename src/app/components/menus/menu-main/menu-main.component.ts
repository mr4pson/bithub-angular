...
export class CMenuMainComponent {
    ...
    get pages(): IPage[] {return this.menumainService.pages;}
    get lang(): ILang {return this.appService.lang.value;}
    get url(): string[] {return this.appService.url;}

    public getPageLink(page: IPage): string {
        return page.slug === "home" ? `/${this.lang.slug}` : `/${this.lang.slug}/${page.slug}`;
    }

    public isPageActive(page: IPage): boolean {
        return page.slug === "home" ? !this.url[2] : this.url[2] === page.slug;
    }
}