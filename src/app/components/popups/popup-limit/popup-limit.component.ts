...
@Component({
    ...
    styleUrls: [
        "../../../styles/popups.scss",
        "popup-limit.component.scss",
    ],
    encapsulation: ViewEncapsulation.None,
})
export class CPopupLimitComponent extends CPopupComponent implements OnInit, OnChanges {
    ...
    get total(): string {
        ...
        return (amount - (this.promocode ? amount / 100 * this.promocode.discount : 0)).toFixed(2);
    }
    ...
    public async onPay(): Promise<void> {
        try {
            this.loading = true;
            this.error = null;
            const dto: IOutorderCreate = {tariff_id: this.tariff.id, code: this.promocode?.code, q: this.q};
