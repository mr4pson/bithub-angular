...
import { CProfileReferInfoComponent } from './components/profile-refer-info/profile-refer-info.component';

let routes = RouterModule.forChild([{ path: '', component: CAccountPage }]);
