...
export class COneArticlesPage {
    ...
    get img(): string {return this.article.img;}
    ...
    get yt_content(): string {return this.article.yt_content;}
    get date(): string {return this.article.date;}
    get readtime(): number {return this.article.readtime;}
